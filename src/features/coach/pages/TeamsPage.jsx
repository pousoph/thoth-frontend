...
import { fetchCoachDashboard, searchAvailableContestants, createTeam } from '../services/coachService';
import {
                  ...
                  <td>
                    <div className="co-table__actions">
                      <button
                        ...
                        onClick={(e) => { e.stopPropagation(); navigate(`/coach/teams/${team.team_id}`); }}
                      >
                        Ver detalle
                      </button>
                    </div>
