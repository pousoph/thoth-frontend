...
const NameRow = ({ formData, handleChange }) => (
...
const BirthDateField = ({ formData, handleChange }) => (
...
const GenderSizeRow = ({ formData, handleChange }) => (
    <div className="step-fields step-fields--row">
        <div className="input-group">
...
const CodeforcesField = ({ formData, handleChange }) => (
    <div className="input-group">
...
const StepActions = ({ onBack, onFinish, isValid, loading }) => (
    <div className="step-actions">
        <Button variant="secondary" onClick={onBack}>
            Atrás
        </Button>
        <Button onClick={onFinish} disabled={!isValid || loading}>
...
const StepPersonal = ({ formData, setFormData, onBack, onFinish, loading }) => {
    ...
    return (
        <div className="step step-personal fade-in">
            ...
            <NameRow formData={formData} handleChange={handleChange} />
            <BirthDateField formData={formData} handleChange={handleChange} />
            <GenderSizeRow formData={formData} handleChange={handleChange} />
            <CodeforcesField formData={formData} handleChange={handleChange} />
            <StepActions onBack={onBack} onFinish={onFinish} isValid={isValid} loading={loading} />
        </div>
    );
};
