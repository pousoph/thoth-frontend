...
function PerformanceChart() {
    const points = [90, 75, 50, 60, 35, 45, 25, 20];

    return (
        <section className="cd-chart-card cd-chart-card--wide">
            <h2 className="cd-chart-title">Rendimiento en competencias</h2>
            <div className="cd-line-chart">
                <div className="cd-line-chart-area">
                    ...
                    >
                        ...
                        />
                        {[0, 40, 80, 120, 160, 200, 240, 280].map((cx, i) => (
                            <circle
                                key={cx}
                                cx={cx}
                                cy={points[i]}
...
function CompetitionsByTypeChart() {
    const rows = [
                ...
                {rows.map((row) => (
                    <div key={row.label} className="cd-bar-row">
                        ...
                        <div className="cd-bar-track">
                            <div className="cd-bar-fill" style={{ width: row.width }} />
                        </div>
...
function RecentCompetitionsChart() {
    const competitions = [
        {
...
function DashboardCharts() {
    return (
        <div className="cd-charts">
            ...
            <CompetitionsByTypeChart />
            <RecentCompetitionsChart />
        </div>
    );
}
